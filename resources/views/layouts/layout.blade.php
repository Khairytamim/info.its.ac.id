...
-->
	...
	<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
		...
		<!-- start navigation -->
		<div class="navbar navbar-fixed-top navbar-default" style="height: 100px" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="#" style="margin-top: 10px" class="navbar-brand"><img src="{{url('/img/icons/logo-its2.png')}}" class="img-responsive" alt="logo"></a>
				</div>
					...
					<div class="col-md-8 col-sm-8">
						<div class="media">
							...
							<div class="media-body wow fadeIn">
								<h3 class="media-heading">Tentang PPID ITS</h3>
										...
										<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
											...
											<div class="panel panel-default">
												...
												<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
													<div class="panel-body">
															...
															Memberikan pelayanan Publik yang Professional, Transparan, Akuntabel sesuai dengan peraturan perundang-undangan yang berlaku.<br><br>
															
															Misi:<br><br>

															1. Menyediakan fasilitas pelayanan publik di ITS<br>
															2. Meningkatkan pelayanan publik dengan pemanfaatan teknologi informasi<br>
															3. Meningkatkan kemampuan sumber daya manusia pelayanan publik
													</div>
												</div>
											</div>
											...
											<div class="panel panel-default">
												...
												<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
													<div class="panel-body">
															Dengan ini, kami menyatakan sanggup menyelenggarakan layanan informasi publik kepada masyarakat terkait penyelenggara tridharma perguruan tinggi oleh Institut Teknologi Sepuluh Nopember sesuai amanat Undang-Undang Nomor 14 Tahun 2008 tentang Keterbukaan Informasi Publik.
													</div>
												</div>
											</div>
		...
		<div id="team">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.3s">
						<img src="{{url('v2/images/team1.jpg')}}" class="img-responsive" alt="team img">
						<h4>Director</h4>
						<h3>JULIA</h3>
						<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy.</p>
						 <ul class="social-icon text-center">
					...
					<div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.6s">
						<img src="{{url('v2/images/team2.jpg')}}" class="img-responsive" alt="team img">
						<h4>Developer</h4>
						<h3>MARY</h3>
						<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy.</p>
						 <ul class="social-icon text-center">
					...
					<div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.9s">
						<img src="{{url('v2/images/team3.jpg')}}" class="img-responsive" alt="team img">
						<h4>Manager</h4>
						<h3>LINDA</h3>
						<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy.</p>
						 <ul class="social-icon text-center">
