 ...
 <section id="tanyakan" style="background: rgb(32,65,127);">
    <div class="container" style="margin-top: 15vh;margin-bottom: 15vh">
        ...
        <h2 style="font-size: 6vh">Formulir Permohonan Penyelesaian Sengketa ke Komisi Informasi</h2>
        @if (session('status'))
        ...
        <form id="sent" action="{{ route('sengketa') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
