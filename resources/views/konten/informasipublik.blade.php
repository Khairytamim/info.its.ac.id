...
<div class="container container-page-its" style="padding-left: 0; padding-right: 0; padding-top: 30px">
 <section class="vc_section vc_custom_1504082602155">
    <div class="vc_row wpb_row vc_row-fluid">
      <div class="col-md-4">
         <a href="">
               <cardblue class="wow fadeInDown" data-wow-delay="0.0s" data-wow-duration="0.8s">
                  <div style="width: 100%">
                     <div style="display: block; margin-left: auto; margin-right: auto; width: 50%; align-items: center;">
                        <img style="display: block; margin: auto;" src="{{ asset('logo/document.png') }}">
                     </div>
                     <div style="display: block; margin-left: auto; margin-right: auto; width: 50%;">
                        <h2 style="color: white; text-align: center">File DIP</h2>
                     </div>
               </div>
               </cardblue>
         </a>
